...
class AcceptGroupRequestModel {
  ...
  factory AcceptGroupRequestModel.fromJson(Map<String, dynamic> json) {
    return AcceptGroupRequestModel(
      ...
      registered_date_gmt: json['registered_date_gmt'],
