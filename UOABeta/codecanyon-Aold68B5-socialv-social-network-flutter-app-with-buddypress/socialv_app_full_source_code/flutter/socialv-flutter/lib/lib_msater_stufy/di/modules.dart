...
import 'package:socialv/lib_msater_stufy/data/cache/account_local.dart';
import 'package:socialv/lib_msater_stufy/data/cache/app_settings_local.dart';
import 'package:socialv/lib_msater_stufy/data/cache/cache_manager.dart';
import 'package:socialv/lib_msater_stufy/data/cache/course_curriculum_local.dart';
...
import 'package:socialv/lib_msater_stufy/data/network/interceptors/interceptor.dart';
import 'package:socialv/lib_msater_stufy/data/network/interceptors/loggining_interceptor.dart';
import 'package:socialv/lib_msater_stufy/data/repository/account_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/assignment_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/auth_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/courses_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/home_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/instructors_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/lesson_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/purchase_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/review_respository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/user_course_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/questions_repository.dart';
import 'package:socialv/lib_msater_stufy/data/repository/final_repository.dart';
import 'package:socialv/lib_msater_stufy/ui/bloc/auth/auth_bloc.dart';
import 'package:socialv/lib_msater_stufy/ui/bloc/quiz_screen/bloc.dart';
import 'package:socialv/lib_msater_stufy/ui/bloc/splash/bloc.dart';
