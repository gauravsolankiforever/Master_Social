...
import 'package:socialv/lib_msater_stufy/ui/screens/course/meta_icon.dart';
import 'package:socialv/lib_msater_stufy/ui/screens/review_write/review_write_screen.dart';
import 'package:socialv/lib_msater_stufy/ui/widgets/MeasureSizeWidget.dart';
...
class _OverviewWidgetState extends State<OverviewWidget> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    if(preferences!.getBool('demo') == null) {
      ...
      demo = preferences!.getBool('demo') as bool;
    }
    super.initState();
  }
