      ...
      children: [
          ...
          children: [
            Container(
              ...
              child: AppTextField(
                ...
                maxLines: 1,
                decoration: inputDecorationFilled(context, label: language!.firstName),
                onChanged: (text) {
                  if (widget.isBilling) {
            ...
            Container(
              ...
              child: AppTextField(
                ...
                textStyle: primaryTextStyle(),
                maxLines: 1,
                decoration: inputDecorationFilled(context, label: language!.lastName),
                onChanged: (text) {
                  if (widget.isBilling) {
        ...
        Container(
          ...
          child: AppTextField(
            ...
            textStyle: primaryTextStyle(),
            maxLines: 1,
            decoration: inputDecorationFilled(context, label: language!.company),
            onChanged: (text) {
              if (widget.isBilling) {
        ...
        Container(
          ...
          child: AppTextField(
            ...
            textStyle: primaryTextStyle(),
            maxLines: 1,
            decoration: inputDecorationFilled(context, label: '${language!.address} 1'),
            onChanged: (text) {
              if (widget.isBilling) {
        ...
        Container(
          ...
          child: AppTextField(
            ...
            textStyle: primaryTextStyle(),
            maxLines: 1,
            decoration: inputDecorationFilled(context, label: '${language!.address} 2'),
            onChanged: (text) {
              if (widget.isBilling) {
          ...
          children: [
            Container(
              ...
              child: AppTextField(
                ...
                textStyle: primaryTextStyle(),
                maxLines: 1,
                decoration: inputDecorationFilled(context, label: language!.city),
                onChanged: (text) {
                  if (widget.isBilling) {
            ...
            Container(
              ...
              child: AppTextField(
                ...
                textStyle: primaryTextStyle(),
                maxLines: 1,
                decoration: inputDecorationFilled(context, label: language!.postCode),
                onChanged: (text) {
                  if (widget.isBilling) {
        ...
        Container(
          ...
          child: AppTextField(
            ...
            textStyle: primaryTextStyle(),
            maxLines: 1,
            decoration: inputDecorationFilled(context, label: language!.phone),
            onChanged: (text) {
              if (widget.isBilling) {
        ...
        Container(
          ...
          child: AppTextField(
            ...
            textStyle: primaryTextStyle(),
            maxLines: 1,
            decoration: inputDecorationFilled(context, label: language!.email),
            onChanged: (text) {
              if (widget.isBilling) {
