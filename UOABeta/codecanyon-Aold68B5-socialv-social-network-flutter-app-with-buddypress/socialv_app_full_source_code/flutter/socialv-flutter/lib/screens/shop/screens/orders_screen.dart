                                    ...
                                    itemBuilder: (ctx, i) {
                                      ...
                                      return Row(
                                        children: [
                                          ...
                                          /* Text(
                                            '${orderList[index].currencySymbol.validate()}${orderItem.total.validate()}',
              ...
              child: DropdownButtonHideUnderline(
                child: ButtonTheme(
                  ...
                  child: DropdownButton<FilterModel>(
                    ...
                    hint: Text('Order Status', style: primaryTextStyle(color: appStore.isDarkMode ? bodyDark : bodyWhite)),
