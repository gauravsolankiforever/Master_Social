        ...
        child: StoryPageView(
          ...
          itemBuilder: (context, pageIndex, storyIndex) {
            ...
            if (!widget.stories[userIndex].items!.validate()[storyIndex].seen.validate())
              viewStory(
                storyId: int.parse(widget.stories[userIndex].items![storyIndex].id.toString()),
                uniqueStoryId: widget.stories[userIndex].items![storyIndex].uniqueId.validate(),
              ).then((value) {
                      ...
                      child: story.mediaType == MediaTypes.photo
                          ? CachedNetworkImage(
                              ...
                              imageBuilder: (context, imageProvider) {
                                int duration = widget.stories[userIndex].items.validate()[storyIndex].duration.toString().toInt();
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(timeStampToDate(int.parse(story.time)), style: secondaryTextStyle(color: Colors.white)),
                            ],
                          ),
                        ],
                      ),
