...
class StoryViewsScreen extends StatefulWidget {
  ...
  const StoryViewsScreen({required this.uniqueStoryId, required this.storyId, required this.viewCount});
...
class _StoryViewsScreenState extends State<StoryViewsScreen> {
  ...
  Future<List<StoryViewsModel>> getViews() async {
    ...
    await getStoryViews(uniqueStoryId: widget.uniqueStoryId, storyId: widget.storyId).then((value) {
                    ...
                    return GestureDetector(
                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            children: [
                              Text(member.userName.validate(), style: boldTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis),
                              6.height,
