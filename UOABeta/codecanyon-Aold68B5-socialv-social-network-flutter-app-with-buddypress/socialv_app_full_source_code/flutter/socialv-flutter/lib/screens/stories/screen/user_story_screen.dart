...
import 'package:socialv/screens/stories/screen/story_views_screen.dart';
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: StoryViewsScreen(
                                            ...
                                            uniqueStoryId: story.uniqueId.validate(),
                                ...
                                showConfirmDialogCustom(
                                  ...
                                  onAccept: (c) {
                                    ifNotTester(() {
                                      ...
                                      deleteStory(storyId: story.id.validate(), storyIndex: story.index.validate()).then((value) {
                                        toast(value.message);
