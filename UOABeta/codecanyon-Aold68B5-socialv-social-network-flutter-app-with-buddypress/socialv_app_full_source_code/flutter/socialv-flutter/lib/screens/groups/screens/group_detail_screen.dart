...
class _GroupDetailScreenState extends State<GroupDetailScreen> {
  bool fetchGp = false;
  GroupDetailModel group = GroupDetailModel();
                          ...
                          child: Column(
                            children: [
                              ProfileHeaderComponent(
                                avatarUrl: widget.groupAvatarImage.validate().isNotEmpty ? widget.groupAvatarImage.validate() : group.groupAvatarImage.validate(),
                                cover: widget.groupCoverImage.validate().isNotEmpty ? widget.groupCoverImage.validate() : group.groupCoverImage.validate(),
                              ),
                              16.height,
                              RichText(
                                text: TextSpan(
