                      ...
                      headerContainer(
                        ...
                        child: Row(
                          ...
                          children: [
                            TextButton(
                              child:
                                  Text(language!.login.toUpperCase(), style: boldTextStyle(color: selectedIndex == 0 ? Colors.white : Colors.white54)),
                              onPressed: () {
                                selectedIndex = 0;
                                setState(() {});
                              },
                            ...
                            TextButton(
                              child: Text(language!.signUp.toUpperCase(),
                                  style: boldTextStyle(color: selectedIndex == 1 ? Colors.white : Colors.white54)),
                              onPressed: () {
                                selectedIndex = 1;
                                setState(() {});
                              },
