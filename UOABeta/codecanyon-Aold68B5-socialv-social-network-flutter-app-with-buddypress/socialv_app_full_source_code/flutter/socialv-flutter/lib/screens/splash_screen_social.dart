...
import 'AllDashboard/AllDashboard.dart';
import 'ChooseCategory/CategoryModule.dart';

class SplashScreenSocial extends StatefulWidget {
  final int? activityId;

  const SplashScreenSocial({this.activityId});

  @override
  State<SplashScreenSocial> createState() => _SplashScreenState();
}

class _SplashScreenState extends State<SplashScreenSocial> {
  @override
  void initState() {
  ...
  Future<void> init() async {
    ...
    // DashboardScreen().launch(context, isNewTask: true);
     ALLDashboardScreen().launch(context, isNewTask: true);
      //CategotyModule().launch(context);
    } else {
