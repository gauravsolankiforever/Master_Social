                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(post.userName.validate(), style: boldTextStyle()),
                                    ...
                                    if (post.userId.validate().toString() == appStore.loginUserId) {
                                      ...
                                      children: [
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(text: ' ${likeList.first.userName.validate()}', style: boldTextStyle(size: 12)),
                                              if (likeList.length > 1) TextSpan(text: ' And ', style: secondaryTextStyle(size: 12)),
                                              if (likeList.length > 1) TextSpan(text: '${likeCount - 1} others', style: boldTextStyle(size: 12)),
                                            ],
                                          ),
                                        ).paddingAll(8).onTap(() {
