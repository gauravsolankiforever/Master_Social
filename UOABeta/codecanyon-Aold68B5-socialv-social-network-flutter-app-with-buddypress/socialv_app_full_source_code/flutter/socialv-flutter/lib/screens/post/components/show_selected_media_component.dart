  ...
  void initState() {
    ...
    if (widget.mediaType.type == MediaTypes.video)
      widget.mediaList.forEach((element) {
        controller.add(VideoPlayerController.network(element.path).initialize().then((_) {
            setState(() {});
      ...
      return HorizontalList(
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: Stack(
              children: [
                Image.file(widget.mediaList[index], height: 80, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(8),
                Positioned(
              ...
              children: [
                controller[index].value.isInitialized
                    ? Container(
                        width: 80,
                        height: 80,
                        child: VideoPlayer(controller[index]).cornerRadiusWithClipRRect(8),
                      )
                    : Container(
